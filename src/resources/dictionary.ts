...
const internationalExam: DictionaryResource[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { name: '太空探索', start: 539 },
      { name: '学校教育', start: 614 },
      { name: '科技发明', start: 1015 },
      { name: '文化历史', start: 1137 },
      { name: '语言演化', start: 1216 },
      { name: '娱乐运动', start: 1284 },
      { name: '物品材料', start: 1460 },
      { name: '时尚潮流', start: 1612 },
      { name: '饮食健康', start: 1725 },
      { name: '建筑场所', start: 1898 },
      { name: '交通旅行', start: 2032 },
      { name: '国家政府', start: 2166 },
      { name: '社会经济', start: 2315 },
      { name: '法律法规', start: 2487 },
      { name: '沙场争锋', start: 2603 },
      { name: '社会角色', start: 2816 },
      { name: '行为动作', start: 2938 },
      { name: '身心健康', start: 3205 },
      { name: '时间日期', start: 3621 },
    ],
  },
  {
    id: 'IELTS-807',
  ...
  },
  {
    id: 'IELTS-oral-900',
    name: '雅思口语 900 beta版',
    description: '雅思口语 900 句，建议在设置中调小外语字体',
    category: '国际考试',
    tags: ['IELTS'],
